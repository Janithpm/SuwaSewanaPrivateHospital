    ...
    <div class="card-body">
        ...
        ?>
            ...
            <div class="d-flex justify-content-center mt-3">
                <form action="viewPatinetReport.php" method="get" class="w-100 flex-column align-items-center d-flex justify-content-center">
                            ...
                            <tbody class="text-center">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button name="btn-select" class="btn btn-primary" value="<?php echo $patient_type . " " . $row['patientID'] . " " . $row['recorded_date'] . " " . $row['recorded_time']; ?>">View</button>
                                        </td>
                                    </tr>
                                <?php
                                }
