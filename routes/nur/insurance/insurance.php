...
<body>
    <main>
        <div class="container">
            <?php titleBox("DASHBOARD : MANAGER", $USER['usr_name'], "Hello, Welcome Back", $USER['employeeID'], "dark", "../../../config/logout.php", "../nur.php", true); ?>

            <div id="addNewInsurance" style="display:none">
                <?php include('addNewInsurance.php') ?>
            </div>
            <div id="viewInsurance">
                <?php include('viewInsurance.php') ?>
            </div>
